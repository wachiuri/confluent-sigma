...
public class SigmaKafkaCacheRulesStore implements SigmaRulesStore {
    final static Logger logger = LogManager.getLogger(SigmaKafkaCacheRulesStore.class);
    ...
    public SigmaKafkaCacheRulesStore(Properties properties) {
    ...
    public Stream<Map.Entry<String, ParsedSigmaRule>> getRulesStream() {
        return this.sigmaRulesCache.entrySet().stream();
    }
